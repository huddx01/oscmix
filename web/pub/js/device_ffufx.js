...
export const device_ffufx = {
	...
	inputs: [
		{ name: 'Analog 1', flags: ['reflevel'], gain: null, reflevel: RL_INPUT },
		{ name: 'Analog 2', flags: ['reflevel'], gain: null, reflevel: RL_INPUT },
		{ name: 'Analog 3', flags: ['reflevel'], gain: null, reflevel: RL_INPUT },
		{ name: 'Analog 4', flags: ['reflevel'], gain: null, reflevel: RL_INPUT },
		{ name: 'Analog 5', flags: ['reflevel'], gain: null, reflevel: RL_INPUT },
		{ name: 'Analog 6', flags: ['reflevel'], gain: null, reflevel: RL_INPUT },
		{ name: 'Analog 7', flags: ['reflevel'], gain: null, reflevel: RL_INPUT },
		{ name: 'Analog 8', flags: ['reflevel'], gain: null, reflevel: RL_INPUT },
		{ name: 'Mic/Inst 9',  flags: ['gain', '48v', 'hi-z', 'autoset'], gain: { min: 0, max: 65 }, reflevel: null },
		{ name: 'Mic/Inst 10', flags: ['gain', '48v', 'hi-z', 'autoset'], gain: { min: 0, max: 65 }, reflevel: null },
		{ name: 'Mic/Inst 11', flags: ['gain', '48v', 'hi-z', 'autoset'], gain: { min: 0, max: 65 }, reflevel: null },
		{ name: 'Mic/Inst 12', flags: ['gain', '48v', 'hi-z', 'autoset'], gain: { min: 0, max: 65 }, reflevel: null },
	...
	outputs: [
		...
		dig('AES L'), dig('AES R'), dig('ADAT 1'), dig('ADAT 2'),
